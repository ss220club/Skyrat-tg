...
/datum/traitor_objective/sabotage_machinery/trap
	...
	description = "Уничтожьте %MACHINE%, чтобы вызвать беспорядок и нарушить работу %JOB%. \
		Если вам удастся заставить другого члена экипажа уничтожить машину с помощью мины-ловушки, \
		вы получите дополнительную награду в качестве %PROGRESSION% репутации и %TC% телекристаллов."
