...
/obj/item/clothing/mask/madness_mask/examine(mob/user)
	...
	if(IS_HERETIC_OR_MONSTER(user))
		. += span_notice("При ношении активно истощает рассудок и стамину находящихся рядом не еретиков.")
		. += span_notice("Если насильно надеть на лицо нееретика, он не сможет снять его добровольно.")
	else
