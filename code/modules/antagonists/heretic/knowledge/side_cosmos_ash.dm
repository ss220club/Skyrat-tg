...
/datum/heretic_knowledge/summon/fire_shark
	...
	desc = "Позволяет трансмутировать пепел, печень и лист плазмы в Огненную акулу. \
...
/datum/heretic_knowledge/spell/space_phase
	name = "Space Phase"
	desc = "Дает вам Space Phase, заклинание, позволяющее свободно перемещаться в космосе. \
