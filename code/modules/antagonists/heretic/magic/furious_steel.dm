/datum/action/cooldown/spell/pointed/projectile/furious_steel
	...
	desc = "Вызовите три серебряных клинка, которые вращаются вокруг вас. \
		Во время вращения, эти клинки защищают вас от атак, но при использовании расходуются. \
		Кроме того, вы можете использовать кнопку, чтобы выстрелить клинками в цель, нанося урон и вызывая кровотечение."
